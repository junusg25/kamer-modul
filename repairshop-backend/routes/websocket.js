...
router.post('/emit/:userId', authenticateToken, authorizeRoles('admin'), async (req, res) => {
  try {
    const { userId } = req.params;
...
router.post('/emit/room/:roomName', authenticateToken, authorizeRoles('admin'), async (req, res) => {
  try {
...
router.post('/emit/role/:role', authenticateToken, authorizeRoles('admin'), async (req, res) => {
  try {
